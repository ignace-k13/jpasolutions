...
public class TrainingServiceTest {
	...
	public void addNewCompanySession() throws PersonNotFoundException {
		...
		Session added = trainingService.addNewCompanySession("DB2BAS",3,3,LocalDate.of(2024,11,28));
		System.out.println(sessionRepository.findById(added.getSessionId()));
		long sessionsAfter = sessionRepository.count();
		assertEquals(1,sessionsAfter-sessionsBefore);
		assertEquals("c",added.getKind());
	    assertEquals("c",sessionRepository.findSkindValue(added.getSessionId()));
	}
