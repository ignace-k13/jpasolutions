...
public class AbisCourseService implements CourseService {
    ...
    public void updatePrice(int id, double newPrice) {
        courseRepository.updatePrice(id,newPrice);
    }

    @Override
    public void updatePriceViaProcedure(int id, double newPrice) {
        courseRepository.updatePriceViaProcedure(id,newPrice);
    }

    @Override
    public int numberOfCourseByPriceAndDays(double dayPrice, int numberOfDays) {
        return courseRepository.numberOfCourseByPriceAndDays(dayPrice,numberOfDays);
    }
